...
class M3LDataset(Dataset):
    ...
    def __init__(self, X_contextual, X_bow, X_image_emb, idx2token, num_lang=2, is_inference=False, image_embeddings_index = None):
    ...
    def __getitem__(self, i):
        ...
        if self.inference_mode is False:
            if type(self.X_bow[0][i]) == scipy.sparse.csr_matrix: #if type(self.X_bow[0][i]) == scipy.sparse.csr.csr_matrix:
                X_bow_collect = []
