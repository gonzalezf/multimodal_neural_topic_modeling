...
class WhiteSpacePreprocessingM3L():
    ...
    def __init__(self, documents, image_urls, stopwords_languages, vocabulary_size=2000, min_len=10, max_len=200):
        ...
        self.num_lang = 1 #len(stopwords_languages)
        self.languages = stopwords_languages
        self.stopwords = []
        #for lang in self.languages:
            #self.stopwords.append(set(stop_words.words(lang)))
        self.stopwords.append(set(stop_words.words(self.languages)))
    ...
    def preprocess(self):
        ...
        for l in range(1):
            print("Preprocessing", len(self.documents[l]), "documents")
        ...
        for l in range(1):
            ...
            vocabulary_lang = set(vectorizer.get_feature_names_out())
        ...
        return preprocessed_data_final[0], unpreprocessed_data_final[0], vocabulary[0], image_urls_final

class WhiteSpacePreprocessingM3L_OLD():
    """
    Provides a very simple preprocessing script for aligned multimodal AND multilingual data
    """
    def __init__(self, documents, image_urls, stopwords_languages, vocabulary_size=2000, min_len=10, max_len=200):
