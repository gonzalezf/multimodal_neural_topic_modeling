...
from ctm_multimodal_package.utils.early_stopping.early_stopping import EarlyStopping
from ctm_multimodal_package.networks.decoding_network import DecoderNetwork
...
class CTM:
    ...
    def _train_epoch(self, loader):
        ...
        for batch_samples in loader:
            ...
            # forward pass  #Decoder network

            #So prior mean and prior variance are from the encoder, right?
